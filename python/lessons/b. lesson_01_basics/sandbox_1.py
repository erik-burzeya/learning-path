...
def day1_3():
    ...
    # A variable is a name that refers to a value. You can think of it as a
    # container that holds data.
    # In Python, you can create a variable by assigning a value to it using
    # the = operator.
    print(name)
    print(age)
    ...
    # then it returns that input as a string.
    ...
    # Changing str into int (allows us to do math with the input) and then
    # back to str for concatenation in the print statement.
    ...
    # TASK: Create a program that asks the user for their age
    # and then tells them if they are an adult or not.
    # age = int(input("How old are you? ")) -> This line is already included
    # above, so we can reuse the variable 'age' that we created earlier.
    if age >= 18:
    ...
    # Is a user types 'yes' or 'no', we can convert that into a boolean value
    # (True or False).

    # EXAMPLE:
    # has_ticket = input("Ticket (yes/no): ") == "yes"
    # This line checks if the user input is "yes". If it is, has_ticket will
