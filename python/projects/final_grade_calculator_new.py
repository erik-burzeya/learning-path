...
def final_score_range():
    ...
    score = int(input(
        "What is your score for block I.? "
        "Type your score (Calculated with E=P/U * 40): "))
    if score < 200:
    ...
    print()
    print("Your marks may vary slightly. The following is a range within which "
          "your actual marks are likely to fall:")
